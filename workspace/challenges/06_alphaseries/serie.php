    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 d-none d-md-block">
                <img src="<?php echo $serie['images']['poster']; ?>" alt="Poster de Rick and Morty" class="img-thumbnail">
            </div>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            ...
                            <span class="stars text-info" data-toggle="tooltip" data-placement="top" title="<?php echo number_format($serie['statistics']['rating'],2) ?>">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted"><?php echo $serie['statistics']['season_count'] ?> saisons, <?php echo $serie['statistics']['episode_count'] ?> épisodes</h6>
                        <h5>
                            <?php echo number_format($serie['statistics']['popularity'], 0, ' ', ' ') ?> personnes suivent la série
                        </h5>
                        <p>
                            <!-- Affichage des genres de la série -->
                            <?php for ($i=0; $i<count($serie['genres']) ; $i++){ ?>
                            <span class="badge badge-secondary"><?php echo $serie['genres'][$i]?></span>
                            <?php } ?>
                            <small>sortie en <?php echo $serie['release_year']?> chez <?php echo $serie['network']?></small>
                        </p>
                        <p class="card-text">
                            <?php echo $serie['synopsis']?>
                        </p>
                        <a target="_blank" href="https://www.betaseries.com/serie/<?php echo $serie['slug']?>" class="card-link">
                ...
                <div class="card">
                    ...
                    <div class="embed-responsive embed-responsive-21by9">
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $serie['youtube_id']?>?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
