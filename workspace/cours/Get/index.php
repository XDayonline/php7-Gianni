...
<main role="main">
    <div class="jumbotron">
        <div class="container">
            ...
            <p>
                Exemple : <a href="./index.php?firstname=gabriel&lastname=pillet">./index.php?firstname=gabriel&lastname=pillet</a>.
            </p>
            <p>
                <a href="./index.php?firstname=Dark&lastname=Vador" class="btn btn-primary btn-lg" role="button">Dark Vador</a>
            </p>
        </div>
    </div>
</main>
